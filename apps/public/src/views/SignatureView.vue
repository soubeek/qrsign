...
<template>
  <div class="app-fixed-layout bg-gray-50">
    ...
    <div class="flex-1 overflow-auto" style="-webkit-overflow-scrolling: touch;">
      ...
      <div v-else class="max-w-3xl mx-auto p-4 pb-8 space-y-4">
        ...
        <div :style="{ transform: 'scale(' + textZoom / 100 + ')', transformOrigin: 'top left', width: (10000 / textZoom) + '%' }" class="space-y-4">
          ...
          <!-- Declaration (hidden if empty) -->
          <div v-if="declarationText.trim()" class="bg-blue-50 rounded-xl shadow p-5 border border-blue-200 mb-6">
    ...
    <!-- Signature pad — fixed bottom -->
    <div v-if="currentDoc" class="shrink-0 border-t shadow-[0_-2px_10px_rgba(0,0,0,0.08)]" style="background-color: white;">
